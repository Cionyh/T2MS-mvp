...
-- CreateIndex
CREATE INDEX "install_job_assignedWorkerId_status_idx" ON "install_job"("assignedWorkerId", "status");

-- CreateIndex
CREATE INDEX "install_job_customerId_idx" ON "install_job"("customerId");
