      ...
      <DialogContent className="max-w-3xl w-full rounded-3xl p-6 sm:p-8 lg:p-10">
        ...
        <ScrollArea className="h-[60vh] sm:h-[70vh] lg:h-[75vh] overflow-y-auto pr-2">
          <div className="space-y-6 text-sm sm:text-base leading-relaxed text-foreground">
            <p>
              <strong>T2MS (Text2MySite)</strong>, a service provided by Morning
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Do not submit messages containing personal health, financial, or sensitive data</li>
              <li>
                All SMS submissions are processed through Twilio, our
                third-party service provider, and subject to their privacy and
                security practices.
              </li>
            </ul>

            <h3 className="font-semibold">4. Data Sharing</h3>
            <p>We do not sell or share your personal data with third parties for marketing. We only share data with:</p>
            <ul className="list-disc list-inside space-y-1">
            ...
            <p>
              We use SSL encryption, firewalls, and restricted database access
              to protect your data. Your data is encrypted in transit and at rest.
            </p>

            <h3 className="font-semibold">6. Retention</h3>
            <p>
              We retain SMS records for up to 12 months for operational, legal, and
              audit purposes. You may request deletion of your records by contacting us.
            </p>

            <h3 className="font-semibold">7. Opt-Out</h3>
            <p>
              If you no longer wish to use T2MS, email us to deactivate your account and delete stored information.
              You may also stop SMS messages by replying STOP.
            </p>

            <h3 className="font-semibold">8. Children’s Privacy</h3>
            <p>
              T2MS is not intended for children under 13 and does not knowingly
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Deletion or export of your records (subject to legal compliance)</li>
            </ul>
