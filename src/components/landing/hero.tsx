    ...
    >
      <Card className="rounded-[3em] max-w-7xl bg-background border-muted backdrop-blur-lg w-full min-h-screen overflow-auto pt-2">
        ...
        <CardHeader className="flex flex-col items-center gap-4 text-center py-12 px-4 sm:px-10">
          ...
          Text2MySite lets small business owner easily updae key sections of their website by simply sending a tet message.  It's fast, smart, and doesn't require any tech skills.  Just text and it's live.          </CardDescription>
        </CardHeader>
