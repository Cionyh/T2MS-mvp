        ...
        <CardContent className="flex flex-col items-center justify-center gap-8 py-14 px-4 sm:px-10 text-center">
          <div>
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-xl mx-auto">
             T2MS is a breakthrough platform that allows small business owners to update their live websites just by sending a simple text message. Whether it’s posting holiday hours, announcing special offers, or adjusting your status for the day, T2MS makes it effortless — no dashboard, no login, no stress. Your message is sent, and your website is instantly updated.
            </p>
          </div>
